...
public class Constants {
    ...
    public static final String EXPIRY_TIMEOUT = "expiryTimeout";
    public static final String WINDOW_SIZE = "windowSize";
    public static final String CHARSET_NAME = "charsetName";
    public static final String DEFAULT_SESSION_COUNTERS_ENABLED = "defaultSessionCountersEnabled";
    ...
    public static final String DEFAULT_CHARSET = "UCS-2";
}
