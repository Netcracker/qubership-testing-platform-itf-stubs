...
public interface Trigger extends MeansCommunication {

    TriggerState getState();

    void activate() throws TriggerException;

    void deactivate() throws TriggerException;

    void applyConfiguration(ConnectionProperties connectionProperties) throws TriggerException;

    StorableDescriptor getTriggerConfigurationDescriptor();

    String getError();

    boolean checkIfServerAvailable(Map<String, Boolean> availableServers);
}
