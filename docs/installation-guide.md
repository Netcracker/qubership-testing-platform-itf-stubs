...
| `EMBEDDED_TLS12_SERVER_PORT`                         | No        | 9443                                                                                                           | List tls1.2 server port numbers                                    |
| `EMBEDDED_TLS13_SERVER_PORT`                         | No        | 10443                                                                                                          | List tls1.3 server port numbers                                    |
| `EMBEDDED_SSL_SERVER_PORT`                           | No        | 8443                                                                                                           | List ssl server port numbers                                       |
| `KEYSTORE_FILE`                                      | Yes       | keystore.jks                                                                                                   | Keystore file name                                                 |
...
| `ATP_DATASET_URL`                                    | No        | https://atp-dataset-service-address                                                                            | Dataset service integration url                                    |
